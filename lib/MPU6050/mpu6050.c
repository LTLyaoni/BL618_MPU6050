...
#include "driver_mpu6050_code.h"
	/*-----------------------------------macro------------------------------------*/
#define CHIP_NAME "TDK MPU6050"	  /**<芯片名称*/
#define MANUFACTURER_NAME "TDK"	  /**<制造商名称*/
#define SUPPLY_VOLTAGE_MIN 2.375f /**<芯片最小供电电压*/
#define SUPPLY_VOLTAGE_MAX 3.46f  /**<芯片最大供电电压*/
#define MAX_CURRENT 3.9f		  /**<芯片最大电流*/
#define TEMPERATURE_MIN -40.0f	  /**<芯片最低工作温度*/
#define TEMPERATURE_MAX 85.0f	  /**<芯片最大工作温度*/
#define DRIVER_VERSION 1000		  /**<驱动程序版本*/
...
#define MIN(a, b) (((a) < (b)) ? (a) : (b)) /**< min function */
	...
	uint8_t mpu6050_set_iic_fifo_enable(mpu6050_handle_t *handle, mpu6050_iic_slave_t slave, mpu6050_bool_t enable)
	{
		...
		if ((slave == MPU6050_IIC_SLAVE_0) ||
			...
			(slave == MPU6050_IIC_SLAVE_2)) /* slave0-2 */
		{
